...
def main():
    ...
    parser.add_argument("-evaluate", "-ev", action="store_true", help="Evalue les performances du modèle")
    parser.add_argument("--help", "-h", action="store_true", help="Affiche les différents arguments")
    ...
    run_evaluate = args.evaluate or args.all
    run_help = args.help or args.all

    if not (run_clean or run_embed or run_query or run_evaluate or run_help):
